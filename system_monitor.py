...
def create_github_issue(
    ...
    body_lines = [
        ...
        *log_excerpts[-10:],
        ...
        "",
        "### Action Required",
        "1. Check OpenAI billing/quota status",
        "2. Inspect session files for Anthropic reasoning item contamination",
        "3. Clear contaminated session if needed",
        "4. Restart: `rm ~/scripts/logs/openclaw-killed.marker && ~/scripts/start-openclaw.sh`",
    ]
    body = "\n".join(body_lines)
    try:
